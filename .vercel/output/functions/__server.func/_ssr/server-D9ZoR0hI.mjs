...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ir1YyBaB.mjs");
...
const manifest = {
  "66545541b4f603513f22269c2e805052b8ffd80d88e6e5213e9879ef24190623": {
    functionName: "createCheckoutSession_createServerFn_handler",
    importer: () => import("./payments.functions-DhLIcZZd.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B2kWt1Bm.mjs").then((n) => n.r),
    import("./start--wyh4sTq.mjs"),

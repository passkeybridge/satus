...
export OPENAI_API_KEY="sk-..."          # or ANTHROPIC_API_KEY, or XAI_API_KEY
...
- **Generation**: batched structured-output calls (OpenAI and xAI
  `json_schema`, Anthropic tool-forcing) against a JSON schema built from your columns;

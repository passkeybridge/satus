...
description: satus 0.3.5 moves npm releases to a tag-triggered GitHub Actions workflow with npm provenance, restores deferrable-FK detection in introspection, and fixes the Action selftest to validate the in-repo CLI.
date: 2026-07-14
author: satus.sh

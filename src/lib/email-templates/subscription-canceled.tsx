    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          We have processed your cancellation. Your license key will continue to work until the end
          of the current billing period; you will not be charged again.
        </Text>
        ...
        <Text style={paragraph}>
          You can reactivate, change plan, or update payment details in the Stripe billing portal

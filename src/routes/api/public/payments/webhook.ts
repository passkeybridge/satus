...
async function handleSubscriptionUpdated(subscription: any, env: StripeEnv) {
  ...
  const periodEnd = (item as any)?.current_period_end ?? subscription.current_period_end ?? null;
 ...
 */
async function subscriptionIdFromCharge(charge: any, env: StripeEnv): Promise<string | null> {

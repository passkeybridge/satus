    ...
    <main className="satus-fade flex min-h-dvh items-center bg-[var(--paper)] px-6 py-16 text-[var(--ink)]">
      <div className="mx-auto w-full max-w-[640px]">
        ...
        <p className="mt-6 max-w-[60ch] text-[15px] leading-[1.65] text-[var(--ink)]/80">
          You closed checkout before completing payment. The Free tier is the same CLI binary,
          capped at 25 rows per table across 5 tables, with all three built-in profiles and no time
          limit. If Pro doesn&rsquo;t earn its $19 a month, staying on Free is the honest answer.
        </p>
